...
public class RiwayatAproveSampahAdapter extends RecyclerView.Adapter<RiwayatAproveSampahAdapter.ViewHolder> {
    private Context context;
    private ArrayList<StatusSampahModel> menuModels;

    public RiwayatAproveSampahAdapter(Context context, ArrayList<StatusSampahModel> menuModels) {
